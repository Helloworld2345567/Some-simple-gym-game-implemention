...
class SAC(object):
    ...
    def save_model(self, actor_path='models/actor2.pth', critic_path='models/critic2.pth'):
        if not os.path.exists('models/'):
            os.makedirs('models/')

        print('\nSaving models to {} and {}'.format(actor_path, critic_path))
        torch.save(self.policy.state_dict(), actor_path)
        torch.save(self.critic.state_dict(), critic_path)

    # Load model parameters
    def load_model(self, actor_path='models/actor0.pth', critic_path='models/critic0.pth'):
        print('\nLoading models from {} and {}'.format(actor_path, critic_path))
